  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-[110] border-b border-stone-200/70 bg-ivory/90 backdrop-blur-md">
        <div
          className={`${sitePageWideContainerClass} flex h-[4.5rem] items-center justify-between gap-4 px-5 sm:px-8 lg:px-10`}
        >
        ...
        >
          <div
            className={`${sitePageWideContainerClass} grid min-h-12 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-x-4 px-5 py-2.5 sm:px-8 lg:px-10`}
          >
            <div aria-hidden className="min-w-0" />
            <nav aria-label="Main" className="flex min-w-0 items-center justify-center">
              <DesktopMainNav />
            </nav>
